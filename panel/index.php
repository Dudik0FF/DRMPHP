          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <a href="javascript: void(0)" onclick="ExportAll('hls')" class="mb-3 btn btn-info waves-effect btn-label waves-light"><i class="bx bxs-download label-icon"></i> Download .m3u8 (hls)</a>
